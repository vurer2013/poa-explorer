defmodule Indexer.TokenTransfersTest do
  ...
  test "from_log_params/2" do
    ...
    expected = %{
      tokens: [
        %{
          contract_address_hash: "0x91932e8c6776fb2b04abb71874a7988747728bb2",
          type: "ERC-721"
        },
        %{
          contract_address_hash: "0xf2eec76e45b328df99a34fa696320a262cb92154",
          type: "ERC-20"
        }
      ],
      token_transfers: [
        %{
          block_number: 3_664_064,
          log_index: 1,
          from_address_hash: "0x9851ba177554eb07271ac230a137551e6dd0aa84",
          to_address_hash: "0xdccb72afee70e60b0c1226288fe86c01b953e8ac",
          token_contract_address_hash: "0x91932e8c6776fb2b04abb71874a7988747728bb2",
          transaction_hash: "0x4011d9a930a3da620321589a54dc0ca3b88216b4886c7a7c3aaad1fb17702d35",
        },
        %{
